...
class Response implements Responsable
{
     ...
     */
    final public function __construct(private int     $status = 200,
                                      private mixed   $data = [],
     ...
     */
    #[Pure]
    final public static function error(string $message, int $status = 401): self
    {
     ...
     */
    final public static function exceptionError(string $message, int $code = 400)
    {
     ...
     */
    final public static function exceptionValidationError(string $key, string $message): void
    {
     ...
     */
    #[Pure]
    final public static function response(array $properties): self
    {
     ...
     */
    final public function toResponse($request): Factory|View|JsonResponse|Redirector|\Symfony\Component\HttpFoundation\Response|Application|RedirectResponse
    {
